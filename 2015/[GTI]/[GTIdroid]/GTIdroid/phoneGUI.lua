...
-- Mail
Apps["Mail"] = guiCreateStaticImage(x1+12, y2+8, 40, 40, "apps/Mail.png", false, GTIWallpaper)
labels_sdw[5] = guiCreateLabel(x1-2, y2+51, 67, 15, "Mail", false, GTIWallpaper)
labels[5] = guiCreateLabel(x1-2, y2+50, 67, 15, "Mail", false, GTIWallpaper)
guiLabelSetColor(labels[5], 255, 25, 25)
