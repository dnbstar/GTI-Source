...
modShops[1].marker = createMarker(1041.39, -1018.62, 31.5, "cylinder", 4, 255, 0, 0, 100 )
modShops[1].name = "Temple Drive Transfender"

modShops[2] = {}
modShops[2].veh = false
modShops[2].marker = createMarker(2412.27, -2471.46, 12.5, "cylinder", 3, 255, 0, 0, 100)
modShops[2].name = "Ocean Docks Mod Shop"

modShops[3] = {}
modShops[3].veh = false
modShops[3].marker = createMarker(1643.7539, -1516.0722, 12.56, "cylinder", 6, 255, 0, 0, 100)
modShops[3].name = "Downtown Los Santos MS"

modShops[4] = {}
modShops[4].veh = false
modShops[4].marker = createMarker(94.862, -2008.983, 0, "cylinder", 6, 255, 0, 0, 100)
modShops[4].name = "Santa Maria Boat Mods"

modShops[5] = {}
modShops[5].veh = false
modShops[5].marker = createMarker(1431.993, -2439.917, 12.555, "cylinder", 6, 255, 0, 0, 100)
modShops[5].name = "LS Airport Plane Mods"

modShops[6] = {}
modShops[6].veh = false
modShops[6].marker = createMarker( -2723.7060, 217.2689, 2.6133, "cylinder", 3, 255, 0, 0, 100 )
modShops[6].name = "Wheel Arch Angles"

modShops[7] = {}
modShops[7].veh = false
modShops[7].marker = createMarker(-2027.204, 124.581, 28.107, "cylinder", 5, 255, 0, 0, 100)
modShops[7].name = "Doherty Garage Mods"

modShops[8] = {}
modShops[8].veh = false
modShops[8].marker = createMarker(-1936.240, 245.037, 33.461, "cylinder", 6, 255, 0, 0, 100)
modShops[8].name = "Wang Cars Transfender"

modShops[9] = {}
modShops[9].veh = false
modShops[9].marker = createMarker(-1561.03, 1247.93, 0.53, "cylinder", 6, 255, 0, 0, 100)
modShops[9].name = "San Fierro Boat Mods"

modShops[10] = {}
modShops[10].veh = false
modShops[10].marker = createMarker(-1598.853, -631.776, 13.148, "cylinder", 6, 255, 0, 0, 100)
modShops[10].name = "Easter Bay Plane Mods"

modShops[11] = {}
modShops[11].veh = false
modShops[11].marker = createMarker( 1990.6890, 2056.8046, 9.3844, "cylinder", 3, 255, 0, 0, 100 )
modShops[11].name = "LV Transfender"
createObject(11326, 1994.276, 2041.688, 12.063, 0, 0, 90)

modShops[12] = {}
modShops[12].veh = false
modShops[12].marker = createMarker(2171.190, 1393.786, 9.991, "cylinder", 6, 255, 0, 0, 100)
modShops[12].name = "LV Dealership Mods"

modShops[13] = {}
modShops[13].veh = false
modShops[13].marker = createMarker(1409.777, 1811.573, 9.82, "cylinder", 6, 255, 0, 0, 100)
modShops[13].name = "LV Airport Plane Mods"

modShops[14] = {}
modShops[14].veh = false
modShops[14].marker = createMarker( 2414.339, 86.644, 25.512, "cylinder", 5, 255, 0, 0, 100 )
modShops[14].name = "Palomino Transfender"
