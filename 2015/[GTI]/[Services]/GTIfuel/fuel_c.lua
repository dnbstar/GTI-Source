    ...
    if (source == localPlayer) then
        for i, colshape in ipairs ( getElementsByType( "colshape", resourceRoot)) do
            ...
            if not blipCheck[zoneName] then
                ...
                blips[zoneName] = exports.GTIblips:createCustomBlip(x, y, 20, 20, "fblip.png", 450)
            ...
            local duplicate = getElementData(colshape, "GTIfuel.twoblip")
...
addEvent("GTIfuel.addBlips", true)
addEventHandler("GTIfuel.addBlips", root, addBlips)

function addBlipsonResourceStart(resource)
	if (getResourceName(resource) ~= "GTIfuel" and getResourceName(resource) ~= "GTIblips") then return end
...
addEventHandler("onClientResourceStart", resourceRoot, addBlipsonResourceStart)
...
addEventHandler("onClientRender", root,
    function()
        ...
        --->> Math
        local bX, bY, bSX, bSY = aToR( 10, 312+offsetY, 215, 143)

        local barX3, barY3, barSX3, barSY3 = aToR( 29, 358+offsetY, 179, 13) --Dark Green Back
        local barX4, barY4, barSX4, barSY4 = aToR( 29, 358+offsetY, (lastFuel/100)*179, 13) --Green Front
        local lastXDX = barSX4

        local tX1, tY1, tSX1, tSY1 = aToR( 19, 318+(offsetY*2), 218, 335)
        local tX2, tY2, tSX2, tSY2 = aToR( 24, 425+(offsetY*2), 212, 453)
        local tX3, tY3, tSX3, tSY3 = aToR( 19, 340+(offsetY*2), 218, 357)
        local tX4, tY4, tSX4, tSY4 = aToR( 19, 381+(offsetY*2), 218, 398)
        local tX5, tY5, tSX5, tSY5 = aToR( 29, 398+(offsetY*2), 208, 415)
        local wX, wY, wSX, wSY = aToR( ((lastFuel/100)*179)+29, 358+offsetY, (filledFuel/100)*179, 13)
