...
addEventHandler("onClientPreRender", root,
    function()
		...
		dxDrawImageSection( 65, 150, 312, 79, -anim_pos, -(anim_pos+2), 128, 128, idir..viewedImage..".png", 0, 0, 0, tocolor( 255, 255, 255, 55), false)
		...
		for i, tableData in ipairs ( vTable) do
			...
			if restriction >= 269 and restriction <= 809 then
				if tableData[3] and string.find( tableData[3], ",") then
					dxDrawText( name.." ["..tableData[2].." HP]", 100, (209+move)+((offs*i)*2), 266, 289, tocolor(r, g, b, 255), 1.15, "default-bold", "left", "center", false, false, false, false, false)
				else
					dxDrawText( name.."["..tableData[3].." HP]", 75, (209+move)+((offs*i)*2), 266, 289, tocolor(r, g, b, 255), 1.15, "default-bold", "left", "center", false, false, false, false, false)
				end
				if price == "-" then
