...
guiGridListSetSortingEnabled(store.gridlist[1], false)
...
local shops = {
	...
	{ pos = {2391.491, -1905.193, 12.564}, int = 0, dim = 0, shopName = "Cluckin Bell", image = "logo_cbell.png", matrix = {2393.956, -1906.787, 14.530, 2395.001, -2001.221, -18.350}, obj = {2393.358, -1908.915, 13.986}},
	{ pos = {2413.968, -1503.218, 23.009}, int = 0, dim = 0, shopName = "Cluckin Bell", image = "logo_cbell.png", matrix = {2393.956, -1906.787, 14.530, 2395.001, -2001.221, -18.350}, obj = {2393.358, -1908.915, 13.986}},
	--
	...
	{ pos = {2120.666, -1809.189, 12.561}, int = 0, dim = 0, shopName = "Well Stacked Pizza", image = "logo_pizza.png", matrix = {2120.271, -1811.681, 14.326, 2217.862, -1812.163, -7.483}, obj = {2122.102, -1812.083, 13.599}},
	...
	{ pos = {2353.657, 69.694, 19.748}, int = 0, dim = 0, shopName = "Well Stacked Pizza", image = "logo_pizza.png", matrix = {1080.263, -1450.839, 23.737, 983.027, -1451.320, 0.397}, obj = {1078.490, -1450.336, 22.652}}, --Outside
	...
	--
	{ pos = {1034.540, -1345.109, 12.721}, int = 0, dim = 0, shopName = "Rusty Brown Ring Donuts", image = "logo_donut.png", matrix = {2120.104, -1811.151, 14.493, 2217.798, -1812.657, -6.805}, obj = {1035.378, -1351.037, 14.264}},
...
items = {
	...
	['Well Stacked Pizza'] = {
		...
		{ objectid = 2814, cost = 25, hp = 50, name = 'Stacker Box - Large 12" Pizza', file = "pizza", rgb = {154, 53, 53}},
	},
...
function enteredShop(element, matchDim)
	...
	exports.GTIanims:setJobAnimation(localPlayer, false)
	...
	showCursor(true)
	if not getElementInterior(localPlayer, 0) then
