...
local dev_order = {"JTPenn", "LilDolla", "Jack", "Diego", "Emile", "Mitch", "Nerox", "NicKeLz", "Sjoerd", "MagicMayhem", "Ares",
	"MrBrutus", "Derek", "Kanto", "Architects", "GTI Developers", "MTA Community", "Unknown"}
