...
addEventHandler("GTIgovtPanel.composeBanList", root, function(bans)
	...
	for id in pairs(bans) do
		...
		guiGridListSetItemText(bansGUI.gridlist[1], row, 6, bans[id]["ban_time"] or "N/A", false, false)
		guiGridListSetItemText(bansGUI.gridlist[1], row, 7, bans[id]["unban_time"] or "N/A", false, false)
