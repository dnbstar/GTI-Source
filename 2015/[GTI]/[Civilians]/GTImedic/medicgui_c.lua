...
GTImedic.label[3] = guiCreateLabel(215, 26, 228, 16, "Name: ", false, GTImedic.window[1])

GTImedic.label[4] = guiCreateLabel(215, 51, 228, 16, "Health: ", false, GTImedic.window[1])

GTImedic.label[5] = guiCreateLabel(215, 77, 228, 16, "Location: ", false, GTImedic.window[1])

GTImedic.label[6] = guiCreateLabel(215, 103, 228, 16, "Travel State: ", false, GTImedic.window[1])

GTImedic.label[7] = guiCreateLabel(215, 129, 228, 16, "Team: ", false, GTImedic.window[1])
--[[
...
function getDetails( thePlr)
	if thePlr then
		...
		local location, city = getZoneName( tX, tY, tZ, false), getZoneName( x, y, z, true)
