...
addEvent("GTIgangTerritories:onPlayerEnterTurf",true)
addEventHandler("GTIgangTerritories:onPlayerEnterTurf",root,
function()
	turfing = true
end)

addEvent("GTIgangTerritories:onPlayerLeaveTurf",true)
addEventHandler("GTIgangTerritories:onPlayerLeaveTurf",root,
function()
	turfing = false
end)