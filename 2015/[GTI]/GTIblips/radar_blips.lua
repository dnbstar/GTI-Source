...
-- Date: 14 Jun 2013
-- Resource: GTIblips/radar_blips.lua
-- Version: 1.0
----------------------------------------->>

local DEFAULT_VISIBLE_DISTANCE = 500	-- Blip Default Visible Distance
...
{2086.478, 2074.487, 10.055, 45},	-- Sex Shop
	-- Cluckin Bell
...
{211.329, 24.777, 1.571, 63},		-- Blueberry, LS
...
addEventHandler("onClientResourceStart", resourceRoot, function()
	for i,v in ipairs(blips) do
		local blip = createBlip(v[1], v[2], v[3], v[4], 0, 0, 0, 0, 0, 0, DEFAULT_VISIBLE_DISTANCE)
		setElementInterior(blip, v[5] or 0)
		setElementDimension(blip, v[6] or 0)
	end
end)
