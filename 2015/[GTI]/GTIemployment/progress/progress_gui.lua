...
progressGUI.label[20] = guiCreateLabel(11, 277, 121, 15, "Job Account Balance:", false, progressGUI.tab[1])
...
progressGUI.label[50] = guiCreateLabel(138, 277, 161, 15, "$1,234,567", false, progressGUI.tab[1])
