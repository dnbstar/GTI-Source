...
function showIfPedOnPicture()
    if exports.GTIemployment:getPlayerJob(true) and exports.GTIemployment:getPlayerJob() == "Journalist" and isPedDoingTask (localPlayer, "TASK_SIMPLE_USE_GUN" ) and getPedWeapon(localPlayer) == 43 then
...
function handleIfPedOnPicture(jobName, newJob)
	...
	elseif eventName == "onClientResourceStart" and getResourceFromName("GTIemployment") and getResourceState(getResourceFromName("GTIemployment")) == "running" then
	    if exports.GTIemployment:getPlayerJob(true) == "Journalist" then
			addEventHandler("onClientRender", root, showIfPedOnPicture)
		end
	end
end
...
addEventHandler("onClientRender", root, function()
    if not exports.GTIemployment:getPlayerJob(true) == "Journalist" then return false end
	for i=1, #allDeadBodies do
