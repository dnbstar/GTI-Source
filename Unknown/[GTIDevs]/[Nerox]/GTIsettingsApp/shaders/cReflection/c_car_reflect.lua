...
function startCarPaintReflect()
		...
		setEffectV()
		-- Create stuff
		grunShader = dxCreateShader ( "shaders/cReflection/fx/car_refgrun.fx",1,v.renderDistance,false)
		geneShader = dxCreateShader ( "shaders/cReflection/fx/car_refgene.fx",1,v.renderDistance,false)
		shatShader = dxCreateShader ( "shaders/cReflection/fx/car_refshat.fx",1,v.renderDistance,true)
		...
		if grunShader and geneShader and shatShader and myScreenSource then
			...
			-- Set texture
			textureVol = dxCreateTexture ( "shaders/cReflection/images/smallnoise3d.dds" )
