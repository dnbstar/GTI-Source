...
function startShaderResource()
 ...
 skydome_shader = dxCreateShader ( "shaders/dynamicSky/shaders/shader_skydome.fx",0,0,true,"object" )
 null_shader = dxCreateShader ( "shaders/dynamicSky/shaders/shader_null.fx" )
 skydome_texture=dxCreateTexture("shaders/dynamicSky/textures/skydome.jpg")
 ...
 txd_skybox = engineLoadTXD('shaders/dynamicSky/models/skybox_model.txd')
 engineImportTXD(txd_skybox, modelID)
 dff_skybox = engineLoadDFF('shaders/dynamicSky/models/skybox_model.dff', modelID)
