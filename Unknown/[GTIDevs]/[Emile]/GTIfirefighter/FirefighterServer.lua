...
addEvent("GTIfirefighter.anim", true)
addEventHandler("GTIfirefighter.anim", root, function()    
    exports.GTIanims:setJobAnimation(client, "VENDING", "VEND_Use", 7000, true, false, false, false)
end )
...
addEvent("GTIfirefighter.freeze", true)
addEventHandler("GTIfirefighter.freeze", root, function(theveh,fre)
...
addEvent("GTIfirefighter.refillit", true)
addEventHandler("GTIfirefighter.refillit", root, function()
	if (exports.GTIemployment:getPlayerJob(client,true) == "Firefighter") then
		giveWeapon(client, 42, 5000)
		exports.GTIhud:dm("Your extinguisher has been refilled.", client, 255, 255, 0)
	end
end )
