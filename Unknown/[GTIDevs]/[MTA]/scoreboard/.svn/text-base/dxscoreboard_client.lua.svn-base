                        ...
                        if content then
                            ...
                            elseif type( content ) == "table" and column.name ~= "name" then
                                if content.type == "image" and content.src then
                                    ...
                                    content.rotOffX = content.rotOffX or 0
                                    content.rotOffY = content.rotOffY or 0
                                    local imgH = (dxGetFontHeight( fontscale(contentFont, scoreboardScale), contentFont )-s(4))*1.5
                                    local countryID = getCountryName( content.id )
									if countryID ~= nil then
										dxDrawImage ( topX+theX+s(1), y+s(1), imgH, 13, content.src, content.rot, content.rotOffX, content.rotOffY, content.color, drawOverGUI ) -- dxGetFontHeight( fontscale(contentFont, scoreboardScale), contentFont )-s(4)
										dxDrawText( countryID, topX+theX+s(6)+imgH, y+s(1), topX+x+s(1+column.width),   y+s(11)+dxGetFontHeight( fontscale(contentFont, scoreboardScale), contentFont ),    tocolor( 0, 0, 0, a or 255 ), fontscale(contentFont, s(1)), contentFont, "left", "top", true, false, drawOverGUI )
										dxDrawText( countryID, topX+theX+s(5)+imgH, y     , topX+x+s(column.width)  ,   y+dxGetFontHeight( fontscale(contentFont, scoreboardScale)      , contentFont ),    tocolor( r or 255, g or 255, b or 255, a or 255 ), fontscale(contentFont, s(1)), contentFont, "left", "top", true, false, drawOverGUI )
                                    end
									end
                            else
