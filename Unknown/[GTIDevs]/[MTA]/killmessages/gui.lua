...
function outputMessage ( message, r, g, b, font )
	...
	--outputDebugString(config.startY.." * "..screenY.." + "..(config.iconHeight*(config.lines-1)).." + "..((config.iconHeight - config.textHeight)/2).." = "..y)
	...
	--outputDebugString(tostring(message)..", "..startX..", "..y..", "..config.align..", "..config.lines..", "..r..", "..g..", "..b..", "..font..", 1")
