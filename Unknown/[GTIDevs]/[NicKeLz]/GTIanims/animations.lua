...
local animsTable = {--block, anim, category, name
		...
		{"MISC", "Scratchballs_01", "Rape", "Scratch balls"},
		...
		{"PAULNMAC", "Piss_loop", "Rape", "Piss"},
		{"PAULNMAC", "Piss_out", "Rape", "Pissing"},
		{"PAULNMAC", "wank_loop", "Rape", "Wanking"},
		...
		{"RAPPING", "RAP_A_Loop", "Rape", "Rape1"},
		{"RAPPING", "RAP_B_Loop", "Rape", "Rape2"},
		{"RAPPING", "RAP_C_Loop", "Rape", "Rape3"}, 
